...
subtitle: "Corso di laurea in Infermierisitca"
...
use_logo("img/bit.ly_infermierisitca-23-slide.png")
```
...
meta() %>%
  meta_general(
    description = "Modulo di STATISTICA MEDICA del corso in Management, Medicina Legale, Epidemiologia e Statistica per il corso di laurea in Infermierisitca",
...
- Materiale didattico: Moodle [bit.ly/infermierisitca-23-moodle](https://bit.ly/infermierisitca-23-moodle)

- Portale accesso slide: [bit.ly/infermierisitca-23-slide](https://bit.ly/infermierisitca-23-slide)
...
- Lezione 1: mercoledì 18 ottobre 2022 - 08:30-12:30
  + (60') intro al corso
  + (60') intro a R/RStudio (facoltativo, non oggetto di esame)
  + [20'] PAUSA
  + (100') statistica descrittiva - prerequisiti e definizioni

- Lezione 2-5:
 + (20') Domande dubbi perplessità
 + (80') Lezione
 + [20'] PAUSA
 + (90') Lezione
 + (30') Esercizi

> Argomenti riportati mano a mano che verranno svolti.
</small>
</small>
...
- Primi 20 minuti vostre domande e risposte
- Una **pausa** da 20 minuti circa a metà lezione
- Ultima mezz'ora esercizi
...
Diapositive: <img src="img/bit.ly_infermierisitca-23-slide.png" width="150px" style="vertical-align: middle"/> [bit.ly/infermierisitca-23-slide](https://bit.ly/infermierisitca-23-slide)
